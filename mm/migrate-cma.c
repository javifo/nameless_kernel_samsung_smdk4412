...
static int __migrate_page(struct address_space *mapping,
		struct page *newpage, struct page *page, int sync,
		int pass, int tries)
{
	int rc;
	...
	rc = migrate_page_move_mapping(mapping, newpage, page, NULL, sync, pass, tries);
		...
		struct page *newpage, struct page *page, bool sync)
{
	...
	rc = migrate_page_move_mapping(mapping, newpage, page, head, sync, 0, 0);
					...
					int pass, int tries)
{
	...
	if (!mapping) {
		...
		rc = fallback_migrate_page(mapping, newpage, page, sync, pass, tries);
...
static int __unmap_and_move(struct page *page, struct page *newpage,
				int force, bool offlining, bool sync, int pass, int tries)
{
	int rc = -EAGAIN;
...
static int unmap_and_move(new_page_t get_new_page, unsigned long private,
			struct page *page, int force, bool offlining, bool sync, int pass, int tries)
{
	int rc = 0;
	int *result = NULL;
